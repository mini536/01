...
div.innerHTML = '<div class="jjxbb"><ul><li><a class="hide">江小白</a><ul>' +
...
///* ! -------------------------------------------------------------------网页调试------------------------------------------------------------------------- */
document.querySelector("a#jjxbb-tiao-jjxbb").addEventListener("click",function(){if(document.querySelector("#__vconsole")){}else{var script=document.createElement('script');if(typeof have=='undefined'){var oHead1007=document.getElementsByTagName('body').item(0);var oScript1007=document.createElement("script");oScript1007.type="text/javascript";oScript1007.src="https://sdk.yujianweb.cn/js/vconsole/dist/vconsole.min.js";oHead1007.appendChild(oScript1007);var have=true}(function(){'use strict';function clearAD(){var vConsole=new VConsole()}setTimeout(()=>{clearAD()},2000)})()}});
///* ! ----------------------------------------------------------------------------------------------------------------------------------------------------- */
})();
///* ! ----------------------------------------------------------------------------------------------------------------------------------------------------- */
}
